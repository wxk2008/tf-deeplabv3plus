...
flags.DEFINE_string('checkpoint_path', '/home/ke/project/deeplab/train_log_path/model.ckpt-1595', 'Checkpoint path')

flags.DEFINE_string('export_path', '/home/ke/project/deeplab/datasets/pascal_voc_seg/deeplabv3_mnv2_pascal_trainval/model.pb',
                    'Path to output Tensorflow frozen graph.')

flags.DEFINE_integer('num_classes', 21, 'Number of classes.')

flags.DEFINE_multi_integer('crop_size', [1440, 1440],
